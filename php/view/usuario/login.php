            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="../../img/login_bibliotecario.jpg"/></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Seja bem-vindo Bibliotecário!!</h1>
                                        <!-- Alert -->
                                        <?php if($msgAlert != '') :?>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="biblioteca.php?login_aluno">Login Aluno!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
