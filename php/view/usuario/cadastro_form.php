                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action='usuario.php' method='post' class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name='cpf' type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="CPF" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input name='telefone' type="text" class="form-control form-control-user" id="exampleLastName"
                                ...
                                <button type='submit' name='cadastrar' class="btn btn-primary btn-user btn-block">
                                    Criar conta
                                </button>
                            </form>
                            <hr>
                            ...
                            <div class="text-center">
                                <a class="small" href="usuario.php?login">Já tem uma conta? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
